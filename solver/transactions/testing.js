...
async function main() {
    ...
    const toAssetAddress = "0xDDAfbb505ad214D7b80b1f830fcCc89B60fb7A83";
    const amount = 1000000; // 100 USDC, USDC is 6 decimals
    const userAddress = "0x288d1d682311018736B820294D22Ed0DBE372188";
    ...
    console.log('this is quote with all route results ', quote);
    console.log('these are avalaible route ', quote.result.routes)

    // Choosing first route from the returned route results 
    const route = quote.result.routes[0];
    console.log('this route is selected', route)

    return

    // Fetching transaction data for swap/bridge tx
    const apiReturnData = await getRouteTransactionData(route);
    console.log('this is route txn data', apiReturnData);
    ...
    console.log('this is allowance target and min approval amt ', allowanceTarget, minimumApprovalAmount)
